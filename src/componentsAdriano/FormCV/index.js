...
export function FormCV () {
    ...
    <div className={color === "light" ? `container-fluid mt-4 mb-5 dark` :  `container-fluid mt-4 mb-5 light`}>    
        <form>
            ...
            <div className="mb-4"><h2>Skills</h2></div>


            <div className="form-check mb-4 col-md-8 col-sm-12 col-lg-8 ">
                <div>
